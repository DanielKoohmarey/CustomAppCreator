...
Notes:
    Download firefox binary of version you want ( < 46, marionette does not support right click on element)
    ...
    Point to the firefox binary when creating the driver
...
class AppWebDriver(object):
    def __init__(self, prefix, auth):
        ...
        self.driver.implicitly_wait(15) # polls DOM when attempting to find/select element
    ...
    def update_selected_configuration(self, configuration, new_fields):
            ...
            try:
                close_save_button = self.driver.find_element_by_id('sysparm_button_close')
            except NoSuchElementException:
                pass
    ...
    def get_visual_task_board_url(self, table_name, state_variables):  
        ...
        try:
            ...
            self.driver.switch_to.frame(self.driver.find_element_by_tag_name('iframe'))
            vtb_present = expected_conditions.presence_of_element_located((By.CLASS_NAME, "sn-vtb"))
